...
#include "custom_control_msgs/msg/dynamic_interface_group_values.hpp"
...
using CmdType = custom_control_msgs::msg::DynamicInterfaceGroupValues;
using StateType = custom_control_msgs::msg::DynamicInterfaceGroupValues;
...
public:
  ...
  CmdType createGpioCommand(
    ...
    const std::vector<custom_control_msgs::msg::InterfaceValue> & interface_values)
  {
    CmdType command;
  ...
  custom_control_msgs::msg::InterfaceValue createInterfaceValue(
    const std::vector<std::string> & interfaces_names,
    const std::vector<double> & interfaces_values)
  {
    custom_control_msgs::msg::InterfaceValue output;
