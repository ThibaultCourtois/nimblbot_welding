...
static const _TelesoudInstruction_type_support_symbol_names_t _TelesoudInstruction_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, telesoud_msgs, msg, TelesoudInstruction)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, telesoud_msgs, msg, TelesoudInstruction)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, telesoud_msgs, msg, TelesoudInstruction)() {
  return &::telesoud_msgs::msg::rosidl_typesupport_c::TelesoudInstruction_message_type_support_handle;
}
