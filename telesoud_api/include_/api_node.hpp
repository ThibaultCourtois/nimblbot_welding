...
#include <telesoud_msgs/msg/telesoud_robot_info.hpp>
...
private:
  ...
  using TelesoudRobotInfoMsg = telesoud_msgs::msg::TelesoudRobotInfo;
  rclcpp::Subscription<TelesoudRobotInfoMsg>::SharedPtr robot_info_subscription_;
  void robotInfoCallback(const std::shared_ptr<TelesoudRobotInfoMsg> msg);
