...
void ApiNode::initialize() {
  ...
  robot_info_subscription_ = this->create_subscription<telesoud_msgs::msg::TelesoudRobotInfo>(
		  "/telesoud/robot_info", 
		  10, 
		  std::bind(&ApiNode::robotInfoCallback, this, std::placeholders::_1)
		  ); 
...
void ApiNode::robotInfoCallback(const std::shared_ptr<TelesoudRobotInfoMsg> msg) {
  ...
  errorDescription_ = msg->error_as_string;
